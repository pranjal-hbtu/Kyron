        ...
        <div className="flex flex-col-reverse md:flex-row w-full my-4 md:my-10 py-4">
          ...
          <div className="md:w-1/2 flex items-center justify-center md:ml-4">
            <p className="mx-2 text-sm md:text-base lg:text-lg text-center">
              ...
              onboarding platform that helps companies in hiring suitable
              talents. First, it discovers talented candidates who have
              appropriate skills. Next, these candidates go through our
              proctored exam platform. Finally, the right candidates with the
              desired skills get selected for the company.
            </p>
          </div>
        </div>
      </div>
