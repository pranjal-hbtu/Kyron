...
<section className='bg-[#FCFFF6]'>
  <div className='mx-4 lg:mx-12'>
    <div className='mb-4 lg:mb-10 text-center'>
      <h1 className='text-xl lg:text-4xl text-[#0a2134] font-extrabold mb-4 pt-8'>Our <span className='text-[#B8FB3C]'>Customers</span></h1>
      <p className='mb-2 lg:mb-4 font-bold text-[#43505b] text-sm lg:text-base'>Some of our very esteemed clients.</p>
    </div>
    ...
    <div className='flex flex-col justify-center items-center'>
      <h3 className='text-2xl lg:text-3xl text-center font-bold mt-10 mb-4 '>Are you ready to revolutionize how you hire tech talent?</h3>
      <button className='bg-[#B8FB3C] hover:bg-black hover:text-white cursor-pointer font-semibold mx-auto px-4 py-2 my-6 rounded-md'>Schedule Demo</button>
    </div>
  </div>
</section>
